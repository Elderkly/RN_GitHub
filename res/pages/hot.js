...
const RouteConfigs = {
  page1: {
    screen: newSeen('JavaScript'),
    navigationOptions: {
      tabBarLabel: 'JavaScript'
    }
  },
  page2: {
    screen: newSeen('React-Native'),
    navigationOptions: {
...
//  加载TopTabNavigator
const MaterialTopTabNavigator = createAppContainer(createMaterialTopTabNavigator(RouteConfigs,TabNavigatorConfig))
